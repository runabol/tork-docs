...
{% cta href="https://github.com/runabol/tork/releases/tag/v0.0.8" target="_blank"  %} Download (0.0.8) {% /cta %}
...
```shell
tar xzvf ~/Downloads/default.release.tork_0.0.8_darwin_arm64.tgz
```
