...
{% cta href="https://github.com/runabol/tork/releases/tag/v0.1.27" target="_blank"  %} Download (0.1.27) {% /cta %}
...
```shell
tar xzvf ~/Downloads/default.release.tork_0.1.27_darwin_arm64.tgz
```
