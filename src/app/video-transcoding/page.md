...
1. Download the Linux [Tork binary](https://github.com/runabol/tork/releases/tag/v0.1.17).

```shell
wget https://github.com/runabol/tork/releases/download/v0.1.17/default.release.tork_0.1.17_linux_amd64.tgz -O tork.tgz
```
