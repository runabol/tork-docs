...
1. Download the Linux [Tork binary](https://github.com/runabol/tork/releases/tag/v0.1.18).

```shell
wget https://github.com/runabol/tork/releases/download/v0.1.18/default.release.tork_0.1.18_linux_amd64.tgz -O tork.tgz
```
