...
description: Video Transcoding Using Cheap Hardware Tutorial
---
...
In this tutorial, we won't get into all the nitty gritty details but instead focus on one aspect which I think is kinda interesting: distributing the video transcoding process across multiple machines in order to speed up the time it takes to process the video.

## My Setup

<img src="/video-transcoding/minipc_cluster.jpg" alt="Mini PC cluster" />
...
You can find the actual workflow definition <a href="https://github.com/runabol/tork/blob/main/examples/split_and_stitch.yaml" target="_blank">here</a> in case you're interested.

For the source video, I had a surpisingly hard time finding quality (HD and above) long-form (over 60 minutes) open-source content for the purpose of this tutorial. So I ended up creating a "master" video file by taking the open-source film <a href="https://mango.blender.org/" target="_blank">Tears of Steel</a> and duplicating it several times to create a ~70 minute long. <a href="https://github.com/runabol/tork/blob/main/examples/aws_create_master.yaml" target="_blank">This</a> is the worklfow I used to create it.
...
1. Download the Linux <a href="https://github.com/runabol/tork/releases/latest" target="_blank">Tork binary</a>. E.g.:
...
4. Start the <a href="https://github.com/runabol/tork-web" target="_blank">Tork Web</a> UI
...
9. Submit the job using the <a href="http://localhost:3000/jobs/create" target="_blank">UI</a>

And... we're done. 91 minutes later.

<img
  src="/video-transcoding/local_1_instance_runtime.png"
  alt="Local 1 instance runtime"
/>
...
<img
  src="/video-transcoding/local_4_instances_runtime.png"
  alt="Local 4 instances runtime"
/>
...
<a
  href="https://github.com/runabol/tork/blob/main/examples/aws_split_and_stitch.yaml"
  target="_blank"
>
  The slighly revised workflow can be found here
</a>
.
...
<img
  src="/video-transcoding/aws_10_instances_runtime.png"
  alt="AWS 10 instances runtime"
/>
...
<img
  src="/video-transcoding/aws_30_instances_runtime.png"
  alt="AWS 30 instances runtime"
/>
...
<img
  src="/video-transcoding/aws_30_instances_transcode.png"
  alt="AWS 30 instances transcode"
/>
...
<img
  src="/video-transcoding/aws_10_instances_transcode.png"
  alt="AWS 10 instances transcode"
/>
